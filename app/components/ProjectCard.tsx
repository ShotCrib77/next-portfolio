...
export default function ProjectCard({
  ...
  return (
    <div className="w-80 rounded-2xl">
      ...
      <div className="rounded-2xl overflow-hidden bg-zinc-950/90 backdrop-blur-2xl backdrop-saturate-150 border border-white/8 shadow-xl shadow-black/50 h-full flex flex-col">
        ...
        <div className="px-5 pt-4 pb-5 flex flex-col flex-1">
          ...
          <div className="h-px w-full bg-white/6 my-4" />
